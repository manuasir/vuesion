...
story.add(
  ...
  () => ({
    ...
    <vue-inline stack-phone stack-tablet-portrait stack-tablet-landscape stack-small-desktop stack-large-desktop>
      ...
      <vue-checkbox label="Checkbox with validation" name="checkbox2" id="checkbox2" required @click="action" v-model="model" />
      <vue-checkbox disabled label="Checkbox disabled" name="checkbox3" id="checkbox3" @click="action" v-model="model" />
    </vue-inline>
    </component-docs>`,
    methods: {
